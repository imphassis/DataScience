...
def friends_of_friends(user):
    ...
    return Counter(
        ...
        # who aren't me  # and aren't my friends.
...
with open("user_ids_by_interest.json", "w") as f:
    json.dump(dict(user_ids_by_interest), f)
...
with open("interests_by_users.json", "w") as f:
    json.dump(dict(interests_by_user_id), f)
